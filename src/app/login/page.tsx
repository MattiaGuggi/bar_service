...
const Page = () => {
  ...
  return (
    <div className="relative min-h-screen flex items-center justify-center bg-stone-950 text-stone-100 px-4 overflow-hidden selection:bg-amber-500 selection:text-stone-950">
      <div className="absolute top-1/4 left-1/2 -translate-x-1/2 -translate-y-1/2 w-120 h-120 bg-amber-600/10 rounded-full blur-[140px] pointer-events-none" />
      <div className="absolute bottom-1/4 left-1/3 w-80 h-80 bg-orange-600/10 rounded-full blur-[120px] pointer-events-none" />
      ...
      <div className="relative w-full max-w-md">
        <div className="flex justify-center mb-6">
          <div className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-stone-900/90 border border-amber-500/20 text-xs font-semibold tracking-wider text-amber-400 backdrop-blur-md shadow-lg shadow-black/40">
            ...
            <span className="uppercase tracking-widest text-[10px]">Craft Cocktail Lounge</span>
          </div>
        </div>
        ...
        <div className="bg-stone-900/60 backdrop-blur-2xl border border-stone-800/80 rounded-3xl p-8 shadow-2xl shadow-black/80">
          <div className="mb-8 text-center">
            <h2 className="text-3xl font-serif font-bold tracking-tight text-stone-100 mb-2">Welcome Back</h2>
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            <div className="space-y-1.5">
              ...
              <div className="relative flex items-center">
                <Mail className="absolute left-4 w-4 h-4 text-stone-500 pointer-events-none transition-colors" />
                <input
                  type="email"
                  name="email"
            ...
            <div className="space-y-1.5">
              ...
              <div className="relative flex items-center">
                <Lock className="absolute left-4 w-4 h-4 text-stone-500 pointer-events-none transition-colors" />
                <input
                  type="password"
                  name="password"
                  placeholder="••••••••"
